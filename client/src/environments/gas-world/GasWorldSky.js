var GasWorldSky = (function () {
    function GasWorldSky() {
        this.repository = 'default';
        this.environment = "water-world";
        this.type = "water-world-sky";
    }
    GasWorldSky.prototype.construct = function () {
        return undefined;
    };
    GasWorldSky.prototype.add = function (engine, entity) {
        if (entity.external) {
            return;
        }
    ...
    GasWorldSky.prototype.remove = function (engine, entity) {
        var scene = engine.renderer.scene;
    ...
    GasWorldSky.prototype.update = function (engine, entity) {
        var scene = engine.renderer.scene;
        var mesh = scene.getMeshByName(entity.id);
        if (mesh) {
...
exports.GasWorldSky = GasWorldSky;
